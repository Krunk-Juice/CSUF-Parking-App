    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Row(
            children: <Widget>[
              Expanded(
                child: ReusableCard(
                  onPress: () => Navigator.pushNamed(context, CsufMap.id),
        ...
        Expanded(
          child: Row(
            children: <Widget>[
              (widget.status == 'Relaxing')
                  ? Expanded(
                      child: ReusableCard(
                        onPress: () =>
                            Navigator.pushNamed(context, ListRelease.id),
                        // colour: kActiveCardColor,
                        cardChild: IconContent(
              ...
              Expanded(
                child: ReusableCard(
                  onPress: () =>
                      Navigator.pushNamed(context, FreeParkingMap.id),
                  // colour: kActiveCardColor,
                  cardChild: IconContent(
        ...
        (widget.status == 'Swaping')
            ...
            : (widget.status == 'Getting Request')
                ? BottomButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, GetRequest.id),
                    title: 'CHECK REQUEST',
                    color: Colors.greenAccent,
                  )
                : (widget.status == 'Releasing' ||
                        widget.status == 'Requesting')
                    ? BottomButton(
                    ...
                    : BottomButton(
                        onPressed: () =>
                            Navigator.pushNamed(context, Release.id),
                        title: 'RELEASE',
  ...
  Future _handleCancel(BuildContext context) {
    return showDialog(
      ...
      builder: (context) => new AlertDialog(
        ...
        content: Text('You want to cancel'),
